...
<ul>
  ...
  <li>Supports customizable rounds and memory usage.</li>
  <li>Simple Node.js API (hash and verify).</li>
...
<table border="1" width="100%">
  ...
  <tr>
    <td>storedHash</td>
    <td>Previously generated hash string (required)</td>
  </tr>
  <tr>
    <td>rounds</td>
    <td>Number of hashing rounds (default: 3)</td>
  ...
  <tr>
    <td>Returns</td>
    <td><code>true</code> if the password matches the hash, <code>false</code> otherwise</td>
  </tr>
</table>
...
<ul>
  ...
  <li>Security warning: This is a custom algorithm, not audited or recommended for production. Use standard libraries like bcrypt or argon2 for sensitive applications.</li>
</ul>
